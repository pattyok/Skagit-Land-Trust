...
class Component implements Component_Interface {
	...
	public function action_add_editor_support() {
		...
		add_theme_support(
			...
			array(
				array(
					'name'  => __( 'Green', 'Lazar-theme' ),
					'slug'  => 'theme-green',
					'color' => '#6d8d39',
				),
				array(
					'name'  => __( 'Green Light', 'Lazar-theme' ),
					'slug'  => 'theme-green-light',
					'color' => '#c0da95',
				),
				array(
					'name'  => __( 'Grey', 'Lazar-theme' ),
					'slug'  => 'theme-grey',
					'color' => '#757575',
				),
				array(
					'name'  => __( 'Grey Dark', 'Lazar-theme' ),
					'slug'  => 'theme-grey-dark',
					'color' => '#3c3b3b',
				),
				array(
					'name'  => __( 'Grey Light', 'Lazar-theme' ),
					'slug'  => 'theme-grey-light',
					'color' => '#f2f2f2',
				),

				array(
					'name'  => __( 'White', 'Lazar-theme' ),
					'slug'  => 'theme-white',
					'color' => '#fff',
				),
			)
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => __( 'Small', 'Lazar-theme' ),
					'shortName' => __( 'S', 'Lazar-theme' ),
					'size'      => 16,
					'slug'      => 'small',
				),
				array(
					'name'      => __( 'Medium', 'Lazar-theme' ),
					'shortName' => __( 'M', 'Lazar-theme' ),
					'size'      => 18,
					'slug'      => 'medium',
				),
				array(
					'name'      => __( 'Large', 'Lazar-theme' ),
					'shortName' => __( 'L', 'Lazar-theme' ),
					'size'      => 31,
					'slug'      => 'large',
				),
				array(
					'name'      => __( 'Larger', 'Lazar-theme' ),
					'shortName' => __( 'XL', 'Lazar-theme' ),
					'size'      => 39,
					'slug'      => 'larger',
				),
			)
		...
		*/
		register_block_pattern(
			...
			array(
				'title'       => __( 'Offset Columns', 'Lazar-theme' ),
				'description' => _x( 'Two column layout 1/3 - 2/3, columns are stacked 100% on mobile and table', 'Block pattern description', 'Lazar-theme' ),
		...
		register_block_pattern(
			...
			array(
				'title'       => __( 'Image Columns', 'Lazar-theme' ),
				'description' => _x( 'Two column layout 1/3 - 2/3, right column is hidden on mobile', 'Block pattern description', 'Lazar-theme' ),
