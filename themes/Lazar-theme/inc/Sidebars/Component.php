 ...
 * * `Lazar_theme()->is_primary_sidebar_active()`
 * * `Lazar_theme()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	const FOOTER_LEFT_SIDEBAR_SLUG  = 'sidebar-footer-left';
	const FOOTER_RIGHT_SIDEBAR_SLUG = 'sidebar-footer-right';
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Left', 'Lazar-theme' ),
				'id'            => static::FOOTER_LEFT_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Left', 'Lazar-theme' ),
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Right', 'Lazar-theme' ),
				'id'            => static::FOOTER_RIGHT_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Right Section', 'Lazar-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Blog Archive Intro', 'Lazar-theme' ),
				'id'            => static::BLOG_ARCHIVE_SLUG,
				'description'   => esc_html__( 'Place content that will appear on the blog archive below the title and above the filters', 'Lazar-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
