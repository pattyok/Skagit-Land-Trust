...
<div class="site-branding">
	...
	<?php
	$skagit_land_trust_description = get_bloginfo( 'description', 'display' );
	if ( $skagit_land_trust_description || is_customize_preview() ) {
		?>
		<p class="site-description <?php echo esc_attr( $tagline_style ); ?>">
			<?php echo $skagit_land_trust_description; /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?>
		</p>
		<?php
	}
	?>
