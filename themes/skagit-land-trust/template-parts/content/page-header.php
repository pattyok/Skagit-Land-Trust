...
if ( is_404() ) {
	...
	<header class="page-header">
		<h1 class="page-title">
			<?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'skagit-land-trust' ); ?>
		</h1>
	</header><!-- .page-header -->
	<?php
	...
	<header class="page-header">
		<h1 class="page-title">
			<?php esc_html_e( 'Nothing Found', 'skagit-land-trust' ); ?>
		</h1>
	</header><!-- .page-header -->
	<?php
	...
	<header class="page-header">
		<h1 class="page-title">
			...
			printf(
				...
				esc_html__( 'Search Results for: %s', 'skagit-land-trust' ),
