...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_enqueue_script(
			'skagit-land-trust-navigation',
			get_theme_file_uri( '/assets/js/navigation.min.js' ),
			array(),
			skagit_land_trust()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
			false
		);
		wp_script_add_data( 'skagit-land-trust-navigation', 'async', true );
		wp_script_add_data( 'skagit-land-trust-navigation', 'precache', true );
		wp_localize_script(
			'skagit-land-trust-navigation',
			'skagitLandTrustScreenReaderText',
			array(
				'expand'   => __( 'Expand child menu', 'skagit-land-trust' ),
				'collapse' => __( 'Collapse child menu', 'skagit-land-trust' ),
			)
		);
	}
