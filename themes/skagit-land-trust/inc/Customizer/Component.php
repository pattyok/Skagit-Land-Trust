...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'choices' => array(
					'title_tagline' => __( 'Display Title & Tagline', 'skagit-land-trust' ),
					'title_only'    => __( 'Display Title Only', 'skagit-land-trust' ),
					'tagline_only'  => __( 'Display Tagline Only', 'skagit-land-trust' ),
					'none'          => __( 'Hide Title & Tagline', 'skagit-land-trust' ),
				),
			)
		);
		...
		$wp_customize->add_section(
			'theme_options',
			array(
				'title'    => __( 'Theme Options', 'skagit-land-trust' ),
		...
		$wp_customize->add_section(
			'blog_customizer',
			array(
				'title'    => __( 'Blog', 'skagit-land-trust' ),
				'priority' => 50,
			)
		);
		// Add Settings.
		...
		$wp_customize->add_control(
			new \WP_Customize_Media_Control(
				...
				array(
					'label'    => __( 'Blog Header Image', 'skagit-land-trust' ),
		...
		$wp_customize->add_control(
			'blog_header_intro',
			array(
				'label'   => esc_html__( 'Intro Text', 'skagit-land-trust' ),
				'section' => 'blog_customizer',
				'type'    => 'textarea',
			)
		);
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'skagit-land-trust-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			array( 'customize-preview' ),
			skagit_land_trust()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
