 ...
 * * `skagit_land_trust()->is_primary_nav_menu_active()`
 * * `skagit_land_trust()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG   => esc_html__( 'Primary', 'skagit-land-trust' ),
				static::SECONDARY_NAV_MENU_SLUG => esc_html__( 'Secondary', 'skagit-land-trust' ),
			)
		);
	}
