 ...
 * * `skagit_land_trust()->is_primary_sidebar_active()`
 * * `skagit_land_trust()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Header Top', 'skagit-land-trust' ),
				'id'            => 'header-top',
				'description'   => esc_html__( 'Place header content that will display above the nav tablet and up.', 'skagit-land-trust' ),
