...
<div class="site-branding">
	...
	<?php
	$lazar_2025_description = get_bloginfo( 'description', 'display' );
	if ( $lazar_2025_description || is_customize_preview() ) {
		?>
		<p class="site-description <?php echo esc_attr( $tagline_style ); ?>">
			<?php echo $lazar_2025_description; /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?>
		</p>
		<?php
	}
	?>
