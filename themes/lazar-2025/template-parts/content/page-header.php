...
if ( is_404() ) {
	...
	<header class="page-header">
		<h1 class="page-title">
			<?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'lazar-2025' ); ?>
		</h1>
	</header><!-- .page-header -->
	<?php
	...
	<header class="page-header">
		<h1 class="page-title">
			<?php esc_html_e( 'Nothing Found', 'lazar-2025' ); ?>
		</h1>
	</header><!-- .page-header -->
	<?php
	...
	<header class="post-archive-header page-header <?php echo esc_attr( $add_class ); ?>">
		...
		<?php
			lazar_2025()->make_breadcrumbs( get_post_type() );
		?>
			<h1 class="page-title">
	...
	<header class="page-header">
		<h1 class="page-title">
			...
			printf(
				...
				esc_html__( 'Search Results for: %s', 'lazar-2025' ),
