...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_enqueue_script(
			'lazar-2025-navigation',
			get_theme_file_uri( '/assets/js/navigation.min.js' ),
			array(),
			lazar_2025()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
			false
		);
		wp_script_add_data( 'lazar-2025-navigation', 'async', true );
		wp_script_add_data( 'lazar-2025-navigation', 'precache', true );
		wp_localize_script(
			'lazar-2025-navigation',
			'lazar2025ScreenReaderText',
			array(
				'expand'   => __( 'Expand child menu', 'lazar-2025' ),
				'collapse' => __( 'Collapse child menu', 'lazar-2025' ),
			)
		);
	}
