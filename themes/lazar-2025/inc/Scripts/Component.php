...
class Component implements Component_Interface {
	...
	protected function get_js_files() : array {
		...
		$js_files = array(
			'lazar-2025-global-js'  => array(
				'file'         => 'global.min.js',
				'dependencies' => array( 'jquery', 'lazar-2025-popover-js' ),
				'in_footer'    => true,
			),
			'lazar-2025-popover-js' => array(
		 ...
		 */
		$js_files       = apply_filters( 'lazar_2025_js_files', $js_files );
		$this->js_files = array();
	...
	public function register_global() {
		...
		foreach ( $js_files as $handle => $data ) {
			...
			$version = lazar_2025()->get_asset_version( $js_dir . $data['file'] );
			$asset   = $js_uri . lazar_2025()->get_asset_path( $data['file'] );
