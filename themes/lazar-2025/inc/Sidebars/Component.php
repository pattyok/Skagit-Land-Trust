 ...
 * * `lazar_2025()->is_primary_sidebar_active()`
 * * `lazar_2025()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Header Top', 'lazar-2025' ),
				'id'            => 'header-top',
				'description'   => esc_html__( 'Place header content that will display above the nav tablet and up.', 'lazar-2025' ),
