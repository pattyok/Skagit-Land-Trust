 ...
 * * `lazar_2025()->is_primary_nav_menu_active()`
 * * `lazar_2025()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG   => esc_html__( 'Primary', 'lazar-2025' ),
				static::SECONDARY_NAV_MENU_SLUG => esc_html__( 'Secondary', 'lazar-2025' ),
			)
		);
	}
