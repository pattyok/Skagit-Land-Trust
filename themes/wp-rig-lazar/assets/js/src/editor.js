...
wp.domReady( function() {
	...
	// Remove Core Image Styles
	wp.blocks.unregisterBlockStyle( 'core/image', 'rounded' );
	wp.blocks.unregisterBlockStyle( 'core/image', 'circular' );
	wp.blocks.unregisterBlockStyle( 'core/image', 'rounded-corners' );
	wp.blocks.unregisterBlockStyle( 'core/image', 'diagonal' );
	wp.blocks.unregisterBlockStyle( 'core/image', 'inverted-diagonal' );
	wp.blocks.unregisterBlockStyle( 'core/image', 'shadow' );
