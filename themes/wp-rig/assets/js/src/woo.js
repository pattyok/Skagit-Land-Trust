( function ( $ ) {
	function setUpQty() {
		const plus =
			'<button class="quantity-button plus">+<span class="screen-reader-text">Subtract 1</span></button>';
		const minus =
			'<button class="quantity-button minus">-<span class="screen-reader-text">Subtract 1</span></button>';

		$( '.quantity input[type=number]' ).wrap(
